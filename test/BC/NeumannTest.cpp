...
// Created    : Tue May 25 2021 04:05:18 PM (+0200)
// Author     : Ivan Mihajlovic Milin
// Description: Neumann boundary test
// Copyright  ETH Zurich. All Rights Reserved.

#include "Cubism/BC/Dirichlet.h"
#include "../test/UnitTests/BC/FieldAndLab.h"
...
TEST(BC, Neumann)
{
    ...
    // TODO: need to change this to using the Neumann class in my own code!!
                   ...
                   const typename FAL::DataType v1)
{
    ...
    FAL fal(FAL::Tensorial::On);    // activate tensorial stencil
    fal.loadData(&bcv);
    const auto &lab = fal.getLab();
...
TEST(BC, NeumannTensorial)
{
    using FALC = FieldAndLab<int, Cubism::EntityType::Cell, 3>;
    // TODO: change this to utilize the Neumann BC class
...
int main(void) {
    // probably will need to populate this and redesign how the entire thing is
    // being run because currently we will not be executing the tests
    printf("High friends, this seems to be working :)\n");
